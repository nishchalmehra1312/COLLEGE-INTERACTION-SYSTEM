              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <%
                        ...
                        assesment= assignment.getAssignmentStudent(id);
                      ...
                      <tr>
                        ...
                        <td><%= a.getDate() %></td>
                        <td><%= a.getDueDate() %></td>
                        <td><form method="post" action="SubmitAssignment"><input type="text" hidden value="<%= a.getAssignmentId() %>" name="assignmentId"><button class="btn btn-primary">Submit</button></form></td>
                        
                        <td>
                         <form method="post" action="SubmissionStudent">
