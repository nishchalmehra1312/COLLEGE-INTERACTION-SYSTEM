            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <%
                          StudentDao studentsData=new StudentDao();
                          List<StudentDto> l1 = studentsData.getAllStudentData();
                      ...
                      <tr>
                        ...
                        <td>
                            <form method="post" action="IndividualStudentGetData">
                                ...
                                <a class="btn btn-danger"  href="ViewDatas?uid=<%= student.getEnrollment_number() %>&cat=student ">view Info</a>
                            </form>
                        </td>
                      </tr>
                     <%
