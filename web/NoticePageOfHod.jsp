              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <%
                        ...
                        List<NoticeDto> n1=new ArrayList<NoticeDto>();
                        n1= notice.getNoticesData(id);
                        String issuedToId = null;
                       Iterator<NoticeDto> iNotice=n1.iterator();
                        
                        while(iNotice.hasNext())
                        {
                            NoticeDto a=iNotice.next();
                      %>
                      <tr>
                         
                          <td><%= a.getNoticeId() %></td>
                        <td><%= a.getDescription() %></td>
                        <td><%= a.getIssuedDate() %></td>
                        <td><%= a.getIssuedTo() %></td>
