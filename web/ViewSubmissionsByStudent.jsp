    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
            ...
            <table class="table table-bordered">
              ...
              <h2 align="center" style="color:red;" >These Are Your Submissions</h2>
              <div class="card-body pt-0">
            ...
            <table class="table table-bordered">
               ...
               <%
                    ResponseAssignmentDao rDao = new ResponseAssignmentDao();
                    List<AssignmentResponseDto> lResponse = new ArrayList<AssignmentResponseDto>();
                    lResponse = rDao.getAllResponsesStudent(id,assignmentIdSession);
                    Iterator<AssignmentResponseDto> iteratorResponse = lResponse.iterator();
                    while(iteratorResponse.hasNext())
                    {
                           AssignmentResponseDto aResp=new AssignmentResponseDto();
                        aResp=iteratorResponse.next();
               %>
                <tr>
                    <td><%= aResp.getAssignmentId() %></td>
                    <td><%= aResp.getSubmissionDate() %></td>
                    <td><%= aResp.getDesccription() %></td>
              </tr>
             <% } %>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
                <a href="ViewAssignmentByStudent.jsp" >Back</a> 
