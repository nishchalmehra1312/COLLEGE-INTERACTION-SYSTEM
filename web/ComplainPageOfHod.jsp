...
<%
   ...
   System.out.println("From jsp page of hod "+category);
    System.out.println("From jsp page of hod ="+id);
%>
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <%
                          ...
                          List<ComplaintDto> listHod = c1.getAllComplaintData(id, category);
                          Iterator<ComplaintDto> itrHod=listHod.iterator();
                          while(itrHod.hasNext())
                          {
                            ComplaintDto complaint = new ComplaintDto();
                            complaint=itrHod.next();
