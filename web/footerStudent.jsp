     ...
     <div class="modal-body">
        <div class="form-group">
          ...
          <select name="hodId">
           ...
           <label>Complain to :</label><br>
           <label>Faculty's</label>
          <select name="facultyId">
              <option value="null">None</option>
              <%
                      
                         
                          List<ManagerDto> l4 = s1.getAllManagerData("faculty");
                          Iterator<ManagerDto> itrManager2=l4.iterator();
                          while(itrManager2.hasNext())
                          {
                            ManagerDto managers = new ManagerDto();
                            managers=itrManager2.next();
          ...
          <select  name="assignedTo">
              ...
              <%
                   StudentDao s=new StudentDao();
                          ...
                          Iterator<StudentDto> itFooter=l.iterator();
                          while(itFooter.hasNext())
                          {
                            StudentDto studentFooter = new StudentDto();
                            studentFooter=itFooter    .next();
              %>
              <option value="<%= studentFooter.getEnrollment_number() %>"><%= studentFooter.getStudent_name() %></option>
          <%
              }
          %>
          </select>
          ...
          <select  name="issuedTo">
              ...
              <%
                   itFooter=l.iterator(); 
                          while(itFooter.hasNext())
                          {
                            StudentDto studentFooter2 = new StudentDto();
                            studentFooter2=itFooter.next();
              %>
              <option value="<%= studentFooter2.getEnrollment_number() %>"><%= studentFooter2.getStudent_name() %></option>
          <%
              }
          %>
          </select>
